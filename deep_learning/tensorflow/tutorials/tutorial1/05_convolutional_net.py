...
def conv(X, w, w2, w3, w4, w_o, p_keep_conv, p_keep_hidden):
...
def load_data():
    ''' wrap the pre-processing inside '''
...
def inputs_placeholder():
    ...
    return [X, Y, p_keep_conv, p_keep_hidden]

def model(X, Y, p_keep_conv, p_keep_hidden): 
    ...
    py_x = conv(X, w, w2, w3, w4, w_o, p_keep_conv, p_keep_hidden)
