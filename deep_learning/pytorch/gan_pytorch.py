...
# D and G are optimized separately
for epoch in range(num_epochs):
    # optimize d
    for d_index in range(d_steps):
        # 1. Train D on real+fake
        D.zero_grad() # reset the grad
        ...
        # important to detach the Generator from the graph to avoid optimization.
